    ...
    <Animated.View entering={FadeInDown.duration(350)}>
      <AuthHeroCanvas height={148}>
        <View className="absolute inset-0 items-center justify-center">
          ...
          >
            <MaterialIcons color={theme.textOnPrimary} name="phone-iphone" size={40} />
          </LinearGradient>
        </View>
        ...
        >
          <MaterialIcons color={theme.ctaPrimary} name="sms" size={20} />
        </Animated.View>
        ...
        >
          <MaterialIcons color={theme.status.resolved} name="verified-user" size={20} />
        </Animated.View>
        ...
        >
          <MaterialIcons color={theme.ctaPrimary} name="lock-outline" size={18} />
        </Animated.View>
        ...
        >
          <MaterialIcons color={theme.status.resolved} name="shield" size={18} />
        </Animated.View>
      </AuthHeroCanvas>
    </Animated.View>
  );
