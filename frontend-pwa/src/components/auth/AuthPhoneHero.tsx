...
import { Lock, MessageSquare, Shield, Smartphone, UserCheck } from "lucide-react";

import { gradientColors, theme } from "@/constants/theme";
import { AuthHeroCanvas } from "./AuthHeroCanvas";

export function AuthPhoneHero() {
  return (
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
      <AuthHeroCanvas height={148}>
        ...
        >
          <MessageSquare className="h-5 w-5" style={{ color: theme.ctaPrimary }} />
        </motion.div>
        ...
        >
          <UserCheck className="h-5 w-5" style={{ color: theme.status.resolved }} />
        </motion.div>
        ...
        >
          <Lock className="h-[18px] w-[18px]" style={{ color: theme.ctaPrimary }} />
        </motion.div>
        ...
        >
          <Shield className="h-[18px] w-[18px]" style={{ color: theme.status.resolved }} />
        </motion.div>
      </AuthHeroCanvas>
    </motion.div>
  );
